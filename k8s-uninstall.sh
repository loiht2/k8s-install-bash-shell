...
(base) ubuntu@gpu-0:~/loiht2/k8s-bash-install$ ls
k8s-install.sh  k8s-install-worker.sh  k8s-uninstall.sh
(base) ubuntu@gpu-0:~/loiht2/k8s-bash-install$ cat k8s-uninstall.sh 
#!/bin/bash
