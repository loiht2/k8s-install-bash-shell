...
kubeadm init --pod-network-cidr=10.244.0.0/16 --control-plane-endpoint=$(hostname -I | awk '{print $1}') --cri-socket=unix:///var/run/containerd/containerd.sock
mkdir -p $HOME/.kube
